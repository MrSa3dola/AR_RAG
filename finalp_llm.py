...
async def start_session():
    ...
    sessions[session_id] = {
        ...
        "features": [],
        "retrieved": ['black circle expensive sofa', 'red wood sofa', 'black square sofa'],
        "active": True
    }
...
async def chat(user_input: UserInput):
    ...
    if current_state == "collecting_features":
        if message.lower() == "done":
            ...
            response = (f"The best fit ones for you are {session['retrieved']}\n"
        ...
        if message.lower() in ["yes", "y"]:
            ...
            response = ("Alright, if you don't like these options, just tell me to get furniture from another websites store. "
        ...
        if message.lower() == "ok":
            ...
            alt_text = alternatives.text if hasattr(alternatives, 'text') else str(alternatives)
